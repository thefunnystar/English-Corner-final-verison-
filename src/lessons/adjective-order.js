...
function AdjOrder() {
    ...
    <div className='page'>
        ...
        <div className='essay__left'>
            ...
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <p className='text-bold'>Ablaut Reduplication (元音顺序)</p>
            <p>&nbsp;</p>
            <p>Wishy-washy</p>
            <p>Mish-mash</p>
            <p>Tick-tock</p>
        ...
        <p className='essay__indented'>Big Bad Wolf</p>
        <p>&nbsp;</p>
        <p className='essay__left'>这些两个形容词很相似,都包括三个英字,中间有元音,第一英字‘b’一样,这两个词也彼此相邻。我猜因
            为这些特正,所以 ablaut reduplication 比形容词顺序重要。Big bad wolf 是普通的句子,我不熟悉其他例
            外。</p>
    </div>
</div>
    )
